...
function userAddCtrl(usersEditServiceResolve, $scope, toastr, UsersService, $state, $stateParams, $modal, $location) {
    ...
    console.log("usac.addressList", usac.addressList);
    $scope.location = {};
    ...
    usac.placeChanged = function () {
		...
		usac.editUserData.address.city = '';
        usac.editUserData.address.fulladdress = '';
        usac.editUserData.location={};
        usac.editUserData.location.lat = '';
        usac.editUserData.location.lng = '';
        //$scope.location = {};
        //$scope.location.lat = '';
        //$scope.location.lng = '';
        usac.place = this.getPlace();
        var locationa = usac.place;
        //$scope.location.lat = usac.place.geometry.location.lat();
        //$scope.location.lng = usac.place.geometry.location.lng();
        usac.editUserData.location.lat = usac.place.geometry.location.lat();
        usac.editUserData.location.lng = usac.place.geometry.location.lng();
        console.log("Location", usac.editUserData);
        if (locationa.name) {
        ...
        for (var i = 0; i < locationa.address_components.length; i++) {
            for (var j = 0; j < locationa.address_components[i].types.length; j++) {
                ...
                if (locationa.formatted_address) {
                    usac.editUserData.address.fulladdress = locationa.formatted_address;
                }
    ...
    usac.submitUserEditData = function submitUserEditData(isValid, data) {
        if (isValid) {
            ...
            console.log("Loacte", data, usac.editUserData);
