...
angular.module('handyforall.accurate', []);
    ...
    .config(['$stateProvider', '$urlRouterProvider', '$httpProvider', '$urlMatcherFactoryProvider', function ($stateProvider, $urlRouterProvider, $httpProvider, $urlMatcherFactoryProvider) {
        ...
        $stateProvider
            ...
            .state('app.accurate', {
                url: '/accurate',
                action: 'all',
                controller: 'AccurateCtrl',
                controllerAs: 'ACL',
                templateUrl: 'app/admin/modules/accurate/views/accurate.html',
                resolve: { 
                    accurateServiceResolve: function (AccurateService) {
                        return AccurateService.getCredentials();
                    }
                }
            })
            .state('app.admins', {
