angular.module('handyforall.categories').controller('subcategoryListCtrl', subcategoryListCtrl);

subcategoryListCtrl.$inject = ['CategoryServiceResolve', 'CategoryService', '$scope','$stateParams'];

function subcategoryListCtrl(CategoryServiceResolve, CategoryService, $scope, $stateParams) {
    var tlc = this;
    ...
    var layout = [
        ...
        {
            name: 'Actions',
            template: '<button class="btn btn-info btn-rounded btn-ef btn-ef-5 btn-ef-5b" ng-if="options.permission.edit != false" ui-sref="app.categories.sub({id:content._id,page:currentpage,items:entrylimit})"><i class="fa fa-edit"></i> <span>Edit</span></button>' +
