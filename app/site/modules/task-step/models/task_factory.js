...
function TaskService($http, $q) {
    ...
    */
    ...
    function requestalltask(data) {
        console.log("Request Sent",data);
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: '/site/task/requestalltask',
            data:data
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err) {
    ...
    function confirmtask(data, time) {
        console.log("Request Sent",data,time);
    ...
    function taskdetails(task) {
      console.log("TASKERRRRRRRRR",task);
      var deferred = $q.defer();
      $http({
          method: 'POST',
    ...
    function profileconfirmtask(task) {
      console.log("Confirm TaskeRRRRRRRRRRRRRR",task);
      var deferred = $q.defer();
      $http({
          method: 'POST',
