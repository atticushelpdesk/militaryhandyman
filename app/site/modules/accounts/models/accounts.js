...
function accountService($http, $q, Upload) {
    var accountService = {
        ...
        accurateBackground:accurateBackground,
        accurateManual:accurateManual
    };
    ...
    function accurateBackground(first,last,email) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: '/check/account/accurateBackground',
            data: {
                firstName : first,
                lastName : last,
                email : email
    ...
    function accurateManual(email) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: '/check/account/accurateManual',
            data: {
                email : email
            }
        }).success(function (data) {
