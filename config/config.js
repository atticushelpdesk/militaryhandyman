...
CONFIG.SECRET_KEY = 'AIzaSyBL3iASzeEZc-2y0yRpgTJYbQDgXp0vDKE';
...
CONFIG.GOOGLE_MAP_API_KEY = 'AIzaSyBocQolEpYJdOAR4raITJmuRpbuia0e3t4';
...
CONFIG.NOTIFICATION.PROVIDER_ARRIVED_ON_YOUR_PLACE = CONFIG.TASKER + ' arrived at your location';
CONFIG.NOTIFICATION.PROVIDER_START_OFF_FROM_HIS_LOCATION = 'Start Billing Clock';
...
CONFIG.SOCIAL_NETWORKS = {
    'facebookAuth': {
        'clientID': '2881699288530283',
        'clientSecret': '62abf99116840e7a356398fbfceccaeb',
        'callbackURL': 'https://www.militaryhandyman.com/auth/facebook/callback'
    },
};
