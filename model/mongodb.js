...
var config_accurate_schema = require('../schema/accurate.schema.js');
...
var accurateSchema = mongoose.Schema(config_accurate_schema.ACCURATE, { timestamps: true, versionKey: false });
...
var accurate = mongoose.model('accurate', accurateSchema, 'accurate');
module.exports = {
    'admins': admins,
    'users': users,
    'tasker': tasker,
