module.exports = function () {
    ...
    controller.save = function (req, res) {
        ...
        data.settings.site_video_url = req.body.site_video_url;
    ...
    controller.accurateCheck = function (req, res) {
        ...
        var accurate = {};
        accurate.settings = {};
        accurate.settings.username = req.body.username;
        accurate.settings.password = req.body.password;

        db.UpdateDocument('settings', { "alias": "accurate" }, accurate, { upsert: true }, function (err, docdata) {
            if(err && !docdata){
    ...
    controller.accurateGet = function (req, res) {
        var data = {};
        data.status = '0';
        db.GetOneDocument('settings', { "alias": "accurate" }, {}, {}, function (err, docdata) {
            if(err && !docdata){
                //console.log("ERROR",err);
                data.response = err;
                res.send(data);
