...
module.exports = function (app, io, i18n) {
    ...
    try {
        ...
        app.post('/mobile/app/multi-booking', mobile_user.multiBooking);
        ...
        app.post('/mobile/app/accurateBackground', mobile.accurateBackground);
        app.post('/mobile/app/accurateManual', mobile.accurateManual);
        app.all('/mobile/user/upload-Task-images', middlewares.commonUpload('uploads/images/task/').any('file'), mobile_user.uploadTaskImages);
