...
module.exports = function (app, io) {
    try {
        ...
        app.post('/site/task/requestalltask', task.requestalltask)
        ...
        app.post('/site/account/upload-task-images', middlewares.commonUpload('uploads/images/task/').single('file'), task.uploadTaskImages);
